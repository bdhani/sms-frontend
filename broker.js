...
async function populateStockOptions() {
    ...
    if(isAll) {
        try {
            const stockDetails = `https://walrus-app-n4rjz.ondigitalocean.app/api/v1/stocks/getAllStocks`;
        ...
        try {
            const stockDetails = `https://walrus-app-n4rjz.ondigitalocean.app/api/v1/stocks/get?id=${stockId}`;
            const response = await fetch(stockDetails);
            const data = await response.json();
            stockOptions = []
...
async function fetchTeamDetails(teamId) {
    try {
        ...
        const teamDetailsEndpoint = `https://walrus-app-n4rjz.ondigitalocean.app/api/v1/teams/get?id=${teamId}`;
...
async function login() {
    ...
    try {
        const loginApiUrl = 'https://walrus-app-n4rjz.ondigitalocean.app/api/v1/brokers/auth';
...
async function placeOrder() {
   ...
   // const price = calculatePrice(quantity, stockSymbol);
    ...
    try {
        ...
        const orderApiUrl = 'https://walrus-app-n4rjz.ondigitalocean.app/api/v1/transactions/add';
